...
namespace Supyrb.EditorTools {
	...
	public class ApplySelectedPrefabs {
		...
		[MenuItem ("GameObject/Apply Changes To Selected Prefabs %#a", false, 100)]
		private static void ApplyPrefabs () {
			SearchPrefabConnections (ApplyToSelectedPrefabs);
		}

		[MenuItem ("GameObject/Revert Changes Of Selected Prefabs %#r", false, 100)]
		private static void ResetPrefabs () {
			SearchPrefabConnections (RevertToSelectedPrefabs);
		}

		[MenuItem ("GameObject/Apply Changes To Selected Prefabs %#a", true)]
		[MenuItem ("GameObject/Revert Changes Of Selected Prefabs %#r", true)]
